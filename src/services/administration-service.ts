...
const AdministrationService = {
  async getSystemRoles(): Promise<ApiResponse<GetRolesResponseDto>> {
    try {
      const response = await getClient().get(
        `${baseApiUrl}/administration/getRoles`
      );
      return response;
    } catch (err: any) {
      return err.response;
  ...
  async getPersonnelById(
    id: string
  ): Promise<ApiResponse<GetPersonnelByIdResponseDto>> {
    try {
      const response = await getClient().get(
        `${baseApiUrl}/administration/getPersonnelById?personnelId=${id}`
      );
      return response;
    } catch (err: any) {
      return err.response;
  ...
  async getPersonnelList(): Promise<ApiResponse<GetPersonnelListResponseDto>> {
    try {
      const response = await getClient().get(
        `${baseApiUrl}/auth/getPersonnelList`
      );
      return response;
    } catch (err: any) {
      return err.response;
  ...
  async registerAdmin(
    registerAdminDto: any
  ): Promise<ApiResponse<RegisterAdminResponseDto>> {
    try {
      const response = await getClient().post(
        `${baseApiUrl}/auth/registerAdmin`,
        registerAdminDto
      );
      return response;
    } catch (err: any) {
  ...
  async registerPersonnel(
    registerPersonnelDto: any
  ): Promise<ApiResponse<RegisterPersonnelResponseDto>> {
    try {
      const response = await getClient().post(
        `${baseApiUrl}/auth/registerPersonnel`,
        registerPersonnelDto
      );
      return response;
    } catch (err: any) {
      return err.response;
  ...
  ): Promise<ApiResponse<UpdatePersonnelResponse>> {
    try {
      const response = await getClient().post(
        `${baseApiUrl}/administration/updatePersonnel`,
        dto
      );
      return response;
    } catch (err: any) {
  ...
  async removePersonnel(dto: any): Promise<ApiResponse<any>> {
    try {
      const response = await getClient().delete(
        `${baseApiUrl}/administration/removePersonnel?personnelEmail=${dto}`
      );
      return response;
    } catch (err: any) {
      return err.response;
