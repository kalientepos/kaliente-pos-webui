...
>('product-catalogues/create', async (dto, thunkAPI) => {
...
>('product-catalogues/update', async (dto, thunkAPI) => {
...
const productsThunkBuilder = (builder: ActionReducerMapBuilder<any>) => {
  builder.addCase(
    ...
    (state: ProductCataloguesPageState) => {
  ...
  builder.addCase(
    ...
    (state: ProductCataloguesPageState, { payload }) => {
  ...
  builder.addCase(
    getAllProductCatalogues.rejected,
    (state: ProductCataloguesPageState) => {
  ...
  builder.addCase(
    ...
    (state: ProductCataloguesPageState, action) => {
      ...
      newProductCatalogueList.splice(
        newProductCatalogueList.findIndex(
          (p) => p.id === removedProductCatalogueId
        ),
        1
      );
