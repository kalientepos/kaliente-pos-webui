...
function ProductCatalogueList() {
    ...
    return (
        <Paper elevation={0}>
                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center"><Typography variant="h6">Parent Catalogue</Typography></TableCell>
                    ...
                    <TableBody>
                        ...
                        {
                            !productCatalogueState.isLoading && productCatalogueState.productCatalogues.map((row) => (
                            <TableRow
                                key={row.id}
                            ...
                            >
                                ...
                                <TableCell align="center">{row.parentCatalogueId}</TableCell>
                                <TableCell align="center">
            ...
            <Box mt={2} />
            <Button startIcon={<AddBoxIcon />} variant="contained" onClick={() => navigate('./add')}>Add New Product Catalogue</Button>
            </Box>
        </Paper>
    )
};
